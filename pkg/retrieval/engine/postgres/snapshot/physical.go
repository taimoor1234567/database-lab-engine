...
/*
	...
	detremine its value based on various sources. If it fails, an error is reported. Using the current
	...
	pg_controldata utility. Note that this is a not exact value of the latest activity in the source
